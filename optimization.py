...
# -*- coding: utf-8 -*-
"""
Created on Wed Jun 30 16:21:20 2021
...
'''
from:
https://huggingface.co/transformers/_modules/transformers/optimization_tf.html#WarmUp
'''
...
# create_optimizer(init_lr=1e-7,num_warmup_steps=50, num_train_steps=100)
